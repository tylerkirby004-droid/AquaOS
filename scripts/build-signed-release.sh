...
for artifact in "$binary" "$output_dir/aquaosctl-linux-amd64" "$output_dir/aquaos-admin-linux-amd64" "$output_dir/aquaos-deploy-linux-amd64" "$output_dir/aquaos-deploy-windows-amd64.exe"; do
